...
{               ?>
							<li><i class="fa fa-phone" aria-hidden="true"></i> <span>+91<?php  echo 9829763994;?></span></li>
							<li><i class="fa fa-phone fa-envelope" aria-hidden="true"></i> <span><?php  echo "manojvyas94@gmail.com";?></span></li>
							<li><i class="fa fa-map-marker" aria-hidden="true"></i> <span><?php echo "Ramdeora";?>.</span></li><?php $cnt=$cnt+1;}} ?>
						</ul>
					</div>
				</div>
